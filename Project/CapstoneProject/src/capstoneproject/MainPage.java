...
public class MainPage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Capstone");
        jLabel2.setName("Capstone"); // NOI18N

        jComboBox1.setBackground(new java.awt.Color(204, 204, 204));
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Explore..", "aRPG", "MMORPG", "Roguelike RPG", "Turn-Based RPG", "Tactical", "Open World RPG", "JRPG" }));
        ...
        jTabbedPane1.addTab("My Library", jPanel5);
